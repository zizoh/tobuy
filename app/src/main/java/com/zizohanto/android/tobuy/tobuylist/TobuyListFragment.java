...
import com.zizohanto.android.tobuyList.databinding.TobuylistItemBinding;
...
public class TobuyListFragment extends Fragment {
    ...
    public static class TobuyListsAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            TobuylistItemBinding binding;
            if (view == null) {
                // Inflate
                LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());

                // Create the binding
                binding = TobuylistItemBinding.inflate(inflater, viewGroup, false);
            } else {
                // Recycling view
