...
public class AddEditTobuyListActivity extends AppCompatActivity implements AddEditTobuyListNavigator {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addtobuylist_act);
    ...
    private AddEditTobuyListFragment findOrCreateViewFragment() {
        // View Fragment
        AddEditTobuyListFragment addEditTaskFragment = (AddEditTobuyListFragment) getSupportFragmentManager()
                .findFragmentById(R.id.contentFrame);

        if (addEditTaskFragment == null) {
            addEditTaskFragment = AddEditTobuyListFragment.newInstance();
